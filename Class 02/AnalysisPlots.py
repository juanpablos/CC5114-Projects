...
def impact_hidden_layer(train_set, test_set, train_expected, test_expected, neuron_layer=3, total_layers=10, epochs=1000,
...
hidden_file = "Analysis/hidden_impact2.csv"
...
impact_hidden_layer(train_set_XOR, test_set_XOR, train_expected_XOR, test_expected_XOR,
                    epochs=600, total_layers=10, neuron_layer=3, output_file=hidden_file)
#
